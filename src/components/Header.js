        ...
        <>
          <div className="header__left items-center gap-6 flex">
            <MenuIcon
              ...
              className="w-8 h-8 text-gray-500 cursor-pointer block xlg:hidden"
            />
          ...
          <div className="header__right flex items-center gap-6">
            <div className="flag flex items-center gap-2">
              <span className="flag-icon flag-icon-pk text-2xl"></span>
              <span className="text-gray-500 text-xl font-medium hidden sm:block">
                Pakistan
              </span>
            </div>
            <i
              onClick={() => setOpenSrc(true)}
              className="fas fa-search text-3xl text-gray-400 hover:text-blue-500 transition-all duration-200 cursor-pointer"
            ></i>
            ...
            <div className="avatar flex items-center gap-4 ml-3 cursor-pointer">
              <div className="avatar__info hidden sm:block">
                <h3 className="lowercase text-gray-500 text-2xl font-medium">
                  johndoe
                </h3>
                <p className="pl-6 lowercase font-normal text-gray-500 text-base">
                  member
                </p>
              </div>
              <img
                src="/images/pic2.png"
                alt="user"
                className="w-16 h-16 border-0 object-cover rounded-full"
              />
            </div>
          </div>
        </>
