...
import { currentRoute, getMenuState, setMenu } from "../slice";
...
export default function Menu() {
  ...
  return (
    <>
      <section
        className={`menu w-97 bg-white h-screen fixed top-0 shadow-lg ${
          menuState ? "left-0" : "-left-full"
        } xlg:left-0 z-[100] transition-all ease-in-out`}
      >
        <div className="menu__logo h-24 flex items-center justify-between px-8">
          ...
          <XIcon
            className="w-8 h-8 text-blue-600 block xlg:hidden cursor-pointer"
        ...
        <nav className="menu__container pl-6 pr-4 overflow-y-scroll myScroll">
          ...
          {/* <div className="charts pt-7">
            <h3 className="font-medium text-gray-400 text-2xl uppercase pb-3 pl-6 select-none pointer-events-none">
              charts
            </h3>
            <Collapse
